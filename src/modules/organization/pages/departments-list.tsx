                  ...
                  <TableRow key={row.department_id}>
                    ...
                    {visible.code !== false ? (
                      <TableCell
                        ...
                        dir={formatCodeDisplay(row.code).dir}
                      >
                    ...
                    {visible.company !== false ? (
                      <TableCell className="px-2 text-xs">
                        <Link
                          href={companyDetailPath(row.company_id ?? "", { from: "departments" })}
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                onClick={() =>
                  confirmBulk && void runBulk(confirmBulk.kind, confirmBulk.targets)
                }
              >
