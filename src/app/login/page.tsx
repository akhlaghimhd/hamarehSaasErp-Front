...
const passwordSchema = z.object({
  identifier: z
    ...
    .refine(
      ...
      { message: "فرمت ایمیل یا موبایل معتبر نیست (مثال: 0912... یا name@domain.com)" }
    ),
...
/** Map raw backend / network messages to friendlier Persian copy */
function friendlyError(raw: string, context: "password" | "otp-mobile" | "otp-code" | "org"): string {
...
/** Small conceptual loading — data flowing into ERP core */
...
/** Lightweight creative challenge after repeated OTP requests */
function SoftHumanCheck({
  onPass,
}: {
  onPass: () => void;
}) {
...
export default function LoginPage() {
  ...
  const onRequestOtp = async () => {
    // Soft anti-bot: after 3 requests in this session, require a tiny creative check
      ...
      <main className="flex min-h-screen">
        <div className="flex w-full flex-col lg:w-[48%] lg:max-w-xl">
          <div className="flex flex-1 flex-col justify-center px-6 py-10 sm:px-10">
            <div className="mb-8">
              <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-xl brand-mark text-white text-sm font-bold">
                ه
              </div>
              <h1 className="text-2xl font-semibold tracking-tight">انتخاب سازمان</h1>
              <p className="mt-1.5 text-sm text-muted-foreground">
                بیش از یک سازمان برای شما فعال است. یکی را انتخاب کنید تا ادامه دهید.
              </p>
            </div>
              ...
              {needHumanCheck ? (
                ...
                <>
                  ...
                  <div className="flex gap-2.5">
                    ...
                    <Button
                      type="button"eneficioclassName="h-11 flex-1"
